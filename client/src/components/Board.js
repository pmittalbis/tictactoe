...
class Board extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this.props.gameUpdatedSubscription !== nextProps.gameUpdatedSubscription) {
      nextProps.getLastGameQuery.subscribeToMore({
        ...
        variables: { gameID: nextProps.gameUpdatedSubscription.gameUpdated.id },
  ...
  async onButtonClick(e) {
    try{
      ...
      notify.show('Server Error, try reconnecting to server.', 'warning', 5000);
      return false;
    }
    return true;
  }
